...
namespace :integration do
  ...
  namespace :vagrant do
    ...
    desc 'Execute ntp test suite'
    task :'ntp' do
      task_runner(config, 'ntp', 'test', concurrency)
    end

    desc 'Execute version-centos test suite'
    task :'version-centos' do
      task_runner(config, 'version-centos', 'test', concurrency)
    end

    desc 'Execute version-debian test suite'
    task :'version-debian' do
      task_runner(config, 'version-debian', 'test', concurrency)
    end
